  ...
  return (
    <Modal show={show} onHide={() => setShow(false)}>
          <Modal.Header closeButton>
            <Modal.Title>Sub-Agent</Modal.Title>
          </Modal.Header>
          <Modal.Body>
                <Form noValidate>
                    {step === 1 && (
                        <div>
                            <Form.Group controlId="userId">
                                <Form.Label>Username <abbr title="Required">*</abbr></Form.Label>
                                <Form.Control
                                    type="text"
                                    name="userId"
                            ...
                            <Form.Group controlId="password">
                                <Form.Label>Password <abbr title="Required">*</abbr></Form.Label>
                                <Form.Control
                                    type="password"
                                    name="password"
                            ...
                            <Form.Group controlId="confirmPassword">
                                <Form.Label>Confirm Password <abbr title="Required">*</abbr></Form.Label>
                                <Form.Control
                                    type="password"
                            ...
                            <Form.Group controlId="currencyType">
                                <Form.Label>Currency <abbr title="Required">*</abbr></Form.Label>
                                <Form.Control
                                    as="select"
                                    name="currencyType"
                    ...
                    {step === 2 && (
                        <div>
                            <Form.Group controlId="firstName">
                                <Form.Label>First Name <abbr title="Required">*</abbr></Form.Label>
                                <Form.Control
                                    type="text"
                                    name="firstName"
                            ...
                            <Form.Group controlId="lastName">
                                <Form.Label>Last Name <abbr title="Required">*</abbr></Form.Label>
                                <Form.Control
                                    type="text"
                                    name="lastName"
                            ...
                            <Form.Group controlId="dateOfBirth">
                                <Form.Label>Date of Birth <abbr title="Required">*</abbr></Form.Label>
                                <Form.Control
                                    type="date"
                                    name="dateOfBirth"
                    ...
                    {step === 3 && (
                        <div>
                            <Form.Group controlId="phone">
                                <Form.Label>Phone <abbr title="Required">*</abbr></Form.Label>
                                <InputGroup >
                                    <Form.Control
                                        as="select"
                                        name="callingCode"
                            ...
                            <Form.Group controlId="email">
                                <Form.Label>Email <abbr title="Required">*</abbr></Form.Label>
                                <Form.Control
                                    type="email"
                                    name="email"
