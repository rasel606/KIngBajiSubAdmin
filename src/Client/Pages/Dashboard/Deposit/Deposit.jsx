...
import { searchDepositTransactions, UpdateDeposits_list, UpdateDeposits_listStutas } from "../../../AdminApi/AxiosAPIService";
  ...
  const approveDeposit = async (transactionID, 
    ...
    console.log(transactionID, 
      ...
      referralCode);
       ...
       try {
         const response = await UpdateDeposits_listStutas(transactionID, 
           userId,
           status,
           referralCode ,
         );
    ...
    <div  >
      ...
      <div className="m-3">
        ...
        <Card  style={{ background: "transparent" }}>
          <DepositTableList data={data} headers={headers} approveDeposit={approveDeposit}  style={{ background: "transparent" }}/>
        </Card>
      </div>
    </div>
  );
