...
import { searchDepositTransactionsReportAprove } from "../../../../AdminApi/AxiosAPIService";
  ...
  const fetchWithdrawals = async () => {
    ...
    try {
      ...
      console.log(params);
             ...
             const response = await searchDepositTransactionsReportAprove (params);
      ...
      <Card style={{ background: "#38094d" }} className="mx-3 ">
        <Card.Body>
          <div className="d-flex justify-content-between align-items-center mb-2">
            <h5 className="text-white mb-0">Deposit Filters</h5>
            <Button
              variant="link"
