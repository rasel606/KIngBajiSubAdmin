...
// import DepositModal from "../Widthdraw/WidthrawModal";
// import GetWayModal from "../../../../Agent/Pages/Dashboard/DepositGetWay/GetWayModal";
                ...
                <td key={colIndex} style={{ color: "#38094d" }}>
                  {header === "isActive" ? (
                    ...
                    <>
                      ...
                      {/* {modalShow && modalShow.Id === row._Id && (
                        <WidthrawGetWayModal
                          row={modalShow.Id || row}
